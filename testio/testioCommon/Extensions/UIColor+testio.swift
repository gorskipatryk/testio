...
public extension UIColor {
    struct Testio {
        ...
        public static let gray = UIColor.color(red: 102, green: 102, blue: 102, alpha: 1)
        public static let headerViewBackground = UIColor.color(red: 242, green: 242, blue: 247, alpha: 1)
    }
